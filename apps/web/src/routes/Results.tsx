    ...
    >
      ...
      <div className="bg-gradient-to-br from-navy-900 to-navy-800 text-white py-14 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            {hasMatches ? "Tes écoles idéales" : "Tes recommandations"}
          </motion.h1>
          ...
          >
            ...
            +30 XP gagnés pour avoir complété ton orientation !
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        {topMatch && (
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-gold-400 to-gold-600 rounded-xl flex items-center justify-center text-navy-900 font-heading font-bold flex-shrink-0">
              🏆
            </div>
            <div>
              <div className="text-xs font-bold text-gold-700 uppercase tracking-wider">Meilleur match</div>
              <div className="font-heading font-bold text-navy-800 text-base">
                {topMatch.university_slug} — {Math.round(topMatch.probability * 100)}% de compatibilité
              </div>
            </div>
          </motion.div>
        )}
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              <h2 className="font-heading text-xl font-bold text-navy-800">
                {state.matches.length} école{state.matches.length > 1 ? "s" : ""} recommandée{state.matches.length > 1 ? "s" : ""}
              </h2>
        ...
        {state?.suggested_tracks && state.suggested_tracks.length > 0 && (
          ...
          >
            <h3 className="font-heading font-bold text-navy-800 mb-4 flex items-center gap-2">
              ...
              Filières et spécialités suggérées
            </h3>
        ...
        >
          <div className="p-6 bg-gradient-to-br from-navy-800 to-navy-900 rounded-2xl text-white">
            ...
            <h4 className="font-heading font-bold mb-2">Parle à Slimane</h4>
          ...
          <div className="p-6 bg-gradient-to-br from-gold-50 to-gold-100/30 rounded-2xl border border-gold-200">
            <div className="text-2xl mb-3">🔄</div>
            <h4 className="font-heading font-bold text-navy-800 mb-2">Recommencer</h4>
            <p className="text-navy-500 text-sm mb-4 leading-relaxed">
              Tu veux tester avec un profil différent ou d'autres préférences ? Relance l'orientation.
            </p>
            <Link
              to="/orientation"
        ...
        <p className="text-center text-xs text-navy-300 mt-8">
          Ces résultats sont des recommandations basées sur ton profil déclaré. Consulte toujours les établissements directement pour confirmer les conditions d'admission. · Conforme CNDP
        </p>
      </div>
    </motion.div>
  );
